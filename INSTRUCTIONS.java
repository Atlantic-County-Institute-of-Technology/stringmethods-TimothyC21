...
public class INSTRUCTIONS {
    public static void main(String[] args) {
        ...
        */
        ...
        //Takes string of values and converts them into array
        ...
        for (int i = 0; i < values.length; i++) {
            //each ASCII value converted to int, then to corresponding character
        ...
        for (int i = 0; i < user.length(); i++) {
            ...
            if (letterVal == 32) {              //if character is a space, print the space
                System.out.print(letterVal);
            } else if (i % 2 == 0) {            //if character is in even index, make uppercase
                if (letterVal > 96) {
                    System.out.print((char)(letterVal - 32));
                } else {
                    System.out.print(letterVal);
                }
            } else {                            //if character is in odd index, make lowercase
                if (letterVal < 96) {
                    System.out.print((char)(letterVal + 32));
                } else {
                    System.out.print(letterVal);
